...
public class Main implements Runnable {
    ...
    /**
     * This function starts the game and initializes all the necessary stuff.
     *
     */
    @Override
    public void run() {
    ...
    private void tick() {
        Timer.tick(); // The FPS Counter
        renderDragon.tick(); // Rendering system

        /*
	 * If the experiment GameExperiments.PLAY_SOUND_ONCE is enabled,
	 * don't check if any sound is playing
         */
